...
const MATCHES = [
  ...
  { date: "2026-06-28", time: "14:00", jornada: 4, phase: "Dieciseisavos", round: "Dieciseisavos", home: { name: "Sudáfrica", flag: "🇿🇦" }, away: { name: "Canadá", flag: "🇨🇦" }, venue: "Los Angeles Stadium, SoFi Stadium 🇺🇸", city: "Inglewood / Los Ángeles", channels: ["dsports"] },
  { date: "2026-06-29", time: "12:00", jornada: 4, phase: "Dieciseisavos", round: "Dieciseisavos", home: { name: "Brasil", flag: "🇧🇷" }, away: { name: "Japón", flag: "🇯🇵" }, venue: "Boston Stadium, Gillette Stadium 🇺🇸", city: "Foxborough / Boston", channels: ["dsports", "caracol", "rcn"] },
  { date: "2026-06-29", time: "15:30", jornada: 4, phase: "Dieciseisavos", round: "Dieciseisavos", home: { name: "Alemania", flag: "🇩🇪" }, away: { name: "Paraguay", flag: "🇵🇾" }, venue: "Estadio Monterrey, Estadio BBVA 🇲🇽", city: "Monterrey", channels: ["dsports", "caracol", "rcn"] },
  { date: "2026-06-29", time: "20:00", jornada: 4, phase: "Dieciseisavos", round: "Dieciseisavos", home: { name: "Países Bajos", flag: "🇳🇱" }, away: { name: "Marruecos", flag: "🇲🇦" }, venue: "Houston Stadium, NRG Stadium 🇺🇸", city: "Houston", channels: ["dsports"] },
  { date: "2026-06-30", time: "12:00", jornada: 4, phase: "Dieciseisavos", round: "Dieciseisavos", home: { name: "Costa de Marfil", flag: "🇨🇮" }, away: { name: "Noruega", flag: "🇳🇴" }, venue: "New York New Jersey Stadium, MetLife Stadium 🇺🇸", city: "East Rutherford / Nueva York-Nueva Jersey", channels: ["dsports"] },
  { date: "2026-06-30", time: "16:00", jornada: 4, phase: "Dieciseisavos", round: "Dieciseisavos", home: { name: "Francia", flag: "🇫🇷" }, away: { name: "Suecia", flag: "🇸🇪" }, venue: "Dallas Stadium, AT&T Stadium 🇺🇸", city: "Arlington / Dallas", channels: ["dsports", "caracol", "rcn"] },
  { date: "2026-06-30", time: "20:00", jornada: 4, phase: "Dieciseisavos", round: "Dieciseisavos", home: { name: "México", flag: "🇲🇽" }, away: { name: "Ecuador", flag: "🇪🇨" }, venue: "Mexico City Stadium, Estadio Azteca 🇲🇽", city: "Ciudad de México", channels: ["dsports"] },
  { date: "2026-07-01", time: "11:00", jornada: 4, phase: "Dieciseisavos", round: "Dieciseisavos", home: { name: "Inglaterra", flag: "🏴󠁧󠁢󠁥󠁮󠁧󠁿" }, away: { name: "RD Congo", flag: "🇨🇩" }, venue: "Atlanta Stadium, Mercedes-Benz Stadium 🇺🇸", city: "Atlanta", channels: ["dsports"] },
  { date: "2026-07-01", time: "15:00", jornada: 4, phase: "Dieciseisavos", round: "Dieciseisavos", home: { name: "Bélgica", flag: "🇧🇪" }, away: { name: "Senegal", flag: "🇸🇳" }, venue: "San Francisco Bay Area Stadium, Levi's Stadium 🇺🇸", city: "Santa Clara / San Francisco Bay Area", channels: ["dsports"] },
  { date: "2026-07-01", time: "19:00", jornada: 4, phase: "Dieciseisavos", round: "Dieciseisavos", home: { name: "Estados Unidos", flag: "🇺🇸" }, away: { name: "Bosnia y Herzegovina", flag: "🇧🇦" }, venue: "Seattle Stadium, Lumen Field 🇺🇸", city: "Seattle", channels: ["dsports"] },
  { date: "2026-07-02", time: "14:00", jornada: 4, phase: "Dieciseisavos", round: "Dieciseisavos", home: { name: "España", flag: "🇪🇸" }, away: { name: "Austria", flag: "🇦🇹" }, venue: "Toronto Stadium, BMO Field 🇨🇦", city: "Toronto", channels: ["dsports"] },
  { date: "2026-07-02", time: "18:00", jornada: 4, phase: "Dieciseisavos", round: "Dieciseisavos", home: { name: "Portugal", flag: "🇵🇹" }, away: { name: "Croacia", flag: "🇭🇷" }, venue: "Los Angeles Stadium, SoFi Stadium 🇺🇸", city: "Inglewood / Los Ángeles", channels: ["dsports"] },
  { date: "2026-07-02", time: "22:00", jornada: 4, phase: "Dieciseisavos", round: "Dieciseisavos", home: { name: "Suiza", flag: "🇨🇭" }, away: { name: "Argelia", flag: "🇩🇿" }, venue: "BC Place Vancouver, BC Place 🇨🇦", city: "Vancouver", channels: ["dsports"] },
  { date: "2026-07-03", time: "13:00", jornada: 4, phase: "Dieciseisavos", round: "Dieciseisavos", home: { name: "Australia", flag: "🇦🇺" }, away: { name: "Egipto", flag: "🇪🇬" }, venue: "Miami Stadium, Hard Rock Stadium 🇺🇸", city: "Miami Gardens / Miami", channels: ["dsports"] },
  { date: "2026-07-03", time: "17:00", jornada: 4, phase: "Dieciseisavos", round: "Dieciseisavos", home: { name: "Argentina", flag: "🇦🇷" }, away: { name: "Cabo Verde", flag: "🇨🇻" }, venue: "Kansas City Stadium, GEHA Field at Arrowhead Stadium 🇺🇸", city: "Kansas City", channels: ["dsports"] },
  { date: "2026-07-03", time: "20:30", jornada: 4, phase: "Dieciseisavos", round: "Dieciseisavos", home: { name: "Colombia", flag: "🇨🇴" }, away: { name: "Ghana", flag: "🇬🇭" }, venue: "Dallas Stadium, AT&T Stadium 🇺🇸", city: "Arlington / Dallas", channels: ["dsports", "caracol", "rcn"] },
